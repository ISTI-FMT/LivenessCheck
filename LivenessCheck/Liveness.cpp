...
using namespace System::Collections::Generic;
        ...
        /// </param>
         System::Collections::Generic::Stack<Movimento^>^ Liveness::CheckLiveness(int trn, int cdb, bool consideraAreeCritiche)
        {
            StatoTreni^ stato2 = statoTreni->Clone();
            stato2->Muovi(trn, cdb);

            return CheckLiveness(stato2, statoAree, consideraAreeCritiche);
        }

         bool Liveness::CheckLiveness(StatoTreni^ statoTreni, StatoAree^ statoAree, System::Collections::Generic::Stack<Movimento^>^ sequenza, System::Collections::Generic::HashSet<StatoTreni^>^ visitati, bool consideraAreeCritiche)
        {
        ...
        System::Collections::Generic::Stack<Movimento^>^ Liveness::CheckLiveness(StatoTreni^ statoTreni, StatoAree^ statoAree, bool consideraAreeCritiche)
        {
